...
/* here to print current date and time */
printDateTime("Now", Carbon::now());
/* here to add two days[or any number you want] to the current date and time */
printDateTime("After Add Two Days", Carbon::now()->addDays(2));
/* here to subtract two weeks[or any number you want] from the current date and time */
printDateTime("After Subtract Two Weeks", Carbon::now()->subWeek(2));
/* here to print how old are you by pass the date of birth of you */
...
/* here to subtract two minutes[or any number you want] from current time as a human readable format */
